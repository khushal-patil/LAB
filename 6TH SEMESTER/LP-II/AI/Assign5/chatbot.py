...
pairs=[
    ...
    [
        r"what is your name ?",
        ["I am a bot created by khushal patil. you can call me crazy!",]
    ],
    [
        r"how are you ?",
    ...
    [
        r"(.*) created ?",
        ["khushal created me using Python's NLTK library ","top secret ;)",]
    ],
    [
        r"(.*) (location|city) ?",
        ['Pune, Maharashtra', 'Mumbai, Maharashtra', 'Delhi, India', 'Banglore, India']
    ],
    [
        r"how is weather in (.*)?",
