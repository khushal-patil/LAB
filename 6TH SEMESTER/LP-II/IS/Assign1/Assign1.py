...
def custom_and(a, b):
    ...
    result = 0
    bit_position = 1  # Start with least significant bit
    ...
    while a > 0 or b > 0:
        ...
        # If both bits are 1, set the corresponding bit in result
...
def custom_xor(a, b):
    ...
    while a > 0 or b > 0:
        ...
        # If bits are different, set the corresponding bit in result
