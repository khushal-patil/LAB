...
--
-- Host: localhost    Database: khushal_assign2
-- ------------------------------------------------------
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `View3` AS select `Borrower`.`cust_name` AS `cust_name`,`Depositer`.`Acc_no` AS `Acc_no` from (`Borrower` join `Depositer` on((`Borrower`.`cust_name` = `Depositer`.`cust_name`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-08-06 13:09:57
